...
var option_list_js_1 = require('./option-list.js');
...
var SelectComponent = (function () {
    ...
    Object.defineProperty(SelectComponent.prototype, "value", {
        ...
        set: function (v) {
            ...
            if (!option_list_js_1.OptionList.equalValues(v, this._value)) {
    ...
    SelectComponent.prototype.updateOptionsList = function (firstTime) {
        ...
        this.optionList = new option_list_js_1.OptionList(this.options);
        if (!firstTime) {
            this.optionList.value = v;
            this.valueChanged();
        }
    ...
    __decorate([
        ...
        __metadata('design:type', select_dropdown_component_js_1.SelectDropdownComponent)
