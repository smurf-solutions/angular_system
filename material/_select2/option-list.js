...
var diacritics_js_1 = require('./diacritics.js');
var OptionList = (function () {
    function OptionList(options) {
        ...
        this._options = options.map(function (option) {
            var o = new option_js_1.Option(option.value, option.label);
            if (option.disabled) {
                o.disable();
            }
            return o;
    ...
    OptionList.prototype.filter = function (term) {
        if (term.trim() === '') {
            ...
            this.options.forEach(function (option) {
                var l = diacritics_js_1.Diacritics.strip(option.label).toUpperCase();
                var t = diacritics_js_1.Diacritics.strip(term).toUpperCase();
